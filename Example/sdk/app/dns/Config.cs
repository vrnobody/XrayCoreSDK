...
namespace Xray.App.Dns {
    ...
    static ConfigReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "dG8aF2FwcC9yb3V0ZXIvY29uZmlnLnByb3RvIr8DCgpOYW1lU2VydmVyEioK",
            ...
            "LmRucy5OYW1lU2VydmVyLk9yaWdpbmFsUnVsZRIzCg5xdWVyeV9zdHJhdGVn",
            "eRgHIAEoDjIbLnhyYXkuYXBwLmRucy5RdWVyeVN0cmF0ZWd5GlAKDlByaW9y",
            "aXR5RG9tYWluEi4KBHR5cGUYASABKA4yIC54cmF5LmFwcC5kbnMuRG9tYWlu",
            "TWF0Y2hpbmdUeXBlEg4KBmRvbWFpbhgCIAEoCRoqCgxPcmlnaW5hbFJ1bGUS",
            "DAoEcnVsZRgBIAEoCRIMCgRzaXplGAIgASgNIr8ECgZDb25maWcSMgoLTmFt",
            "ZVNlcnZlcnMYASADKAsyGS54cmF5LmNvbW1vbi5uZXQuRW5kcG9pbnRCAhgB",
            "Ei0KC25hbWVfc2VydmVyGAUgAygLMhgueHJheS5hcHAuZG5zLk5hbWVTZXJ2",
            "ZXISMgoFSG9zdHMYAiADKAsyHy54cmF5LmFwcC5kbnMuQ29uZmlnLkhvc3Rz",
            "RW50cnlCAhgBEhEKCWNsaWVudF9pcBgDIAEoDBI2CgxzdGF0aWNfaG9zdHMY",
            "BCADKAsyIC54cmF5LmFwcC5kbnMuQ29uZmlnLkhvc3RNYXBwaW5nEgsKA3Rh",
            "ZxgGIAEoCRIUCgxkaXNhYmxlQ2FjaGUYCCABKAgSMwoOcXVlcnlfc3RyYXRl",
            "Z3kYCSABKA4yGy54cmF5LmFwcC5kbnMuUXVlcnlTdHJhdGVneRIXCg9kaXNh",
            "YmxlRmFsbGJhY2sYCiABKAgSHgoWZGlzYWJsZUZhbGxiYWNrSWZNYXRjaBgL",
            "IAEoCBpJCgpIb3N0c0VudHJ5EgsKA2tleRgBIAEoCRIqCgV2YWx1ZRgCIAEo",
            "CzIbLnhyYXkuY29tbW9uLm5ldC5JUE9yRG9tYWluOgI4ARpxCgtIb3N0TWFw",
            "cGluZxIuCgR0eXBlGAEgASgOMiAueHJheS5hcHAuZG5zLkRvbWFpbk1hdGNo",
            "aW5nVHlwZRIOCgZkb21haW4YAiABKAkSCgoCaXAYAyADKAwSFgoOcHJveGll",
            "ZF9kb21haW4YBCABKAlKBAgHEAgqRQoSRG9tYWluTWF0Y2hpbmdUeXBlEggK",
            "BEZ1bGwQABINCglTdWJkb21haW4QARILCgdLZXl3b3JkEAISCQoFUmVnZXgQ",
            "Ayo1Cg1RdWVyeVN0cmF0ZWd5EgoKBlVTRV9JUBAAEgsKB1VTRV9JUDQQARIL",
            "CgdVU0VfSVA2EAJCRgoQY29tLnhyYXkuYXBwLmRuc1ABWiFnaXRodWIuY29t",
            "L3h0bHMveHJheS1jb3JlL2FwcC9kbnOqAgxYcmF5LkFwcC5EbnNiBnByb3Rv",
            "Mw=="));
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      hosts_.WriteTo(ref output, _map_hosts_codec);
      if (ClientIp.Length != 0) {
        output.WriteRawTag(26);
        output.WriteBytes(ClientIp);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18: {
            hosts_.AddEntriesFrom(ref input, _map_hosts_codec);
            break;
          }
          case 26: {
            ClientIp = input.ReadBytes();
